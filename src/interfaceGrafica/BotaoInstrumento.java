...
public class BotaoInstrumento {
        ...
        public BotaoInstrumento(String nomeInstrumento) {
            this.TEXTURA_ON_CLARO = Jaylib.LoadTexture("./assets/ui/modo_claro/botoes_instrumentos/on/botao_" + nomeInstrumento + "_on.png");
            this.TEXTURA_OFF_ESCURO = Jaylib.LoadTexture("./assets/ui/modo_claro/botoes_instrumentos/off/botao_" + nomeInstrumento + "_off.png");
            this.TEXTURA_ON_ESCURO = Jaylib.LoadTexture("./assets/ui/modo_escuro/botoes_instrumentos/on/botao_" + nomeInstrumento + "_on.png");
            this.TEXTURA_OFF_CLARO = Jaylib.LoadTexture("./assets/ui/modo_escuro/botoes_instrumentos/off/botao_" + nomeInstrumento + "_off.png");
        ...
        public void desenhar ( Jaylib.Vector2 posicao, boolean modoEscuro){
            Jaylib.DrawTextureEx(retrieveIMG(modoEscuro),posicao, 0 , 0.25f, Jaylib.WHITE);
        }
